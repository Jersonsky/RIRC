...
<div class="container-fluid">
	<div class="card">
		<div class="card-header">
			<h4 class="card-title">Listar Areas de Influencia</h4>
		</div>
		<div class="card-body">
			...
			<table class="table table-striped table-hover">
				<thead>
					<tr><th></th>
						...
						<?php } else { ?>
							<a href='index.php?pid=<?php echo base64_encode("ui/areaInfluencia/selectAllAreaInfluencia.php") ?>&order=nombre&dir=asc'>
						...
						<?php } else { ?>
							<a href='index.php?pid=<?php echo base64_encode("ui/areaInfluencia/selectAllAreaInfluencia.php") ?>&order=nombre&dir=desc'>
					...
					if($order != "" && $dir != "") {
						$areaInfluencias = $areaInfluencia -> selectAllOrder($order, $dir);
					} else {
						$areaInfluencias = $areaInfluencia -> selectAll();
					}
					$counter = 1;
					foreach ($areaInfluencias as $currentAreaInfluencia) {
						echo "<tr><td>" . $counter . "</td>";
						echo "<td>" . $currentAreaInfluencia -> getNombre() . "</td>";
...
<div class="modal fade" id="modalAreaInfluencia" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
