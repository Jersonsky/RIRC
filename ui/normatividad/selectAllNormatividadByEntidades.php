...
<div class="container-fluid">
	<div class="card">
		<div class="card-header">
			<h4 class="card-title">Get All Normatividad of Entidades: <em><?php echo $entidades -> getNombre() ?></em></h4>
		</div>
		<div class="card-body">
			...
			<table class="table table-striped table-hover">
				<thead>
					<tr><th></th>
						...
						<?php } else { ?>
							<a data-toggle='tooltip' class='tooltipLink' data-original-title='Sort Ascending' href='index.php?pid=<?php echo base64_encode("ui/normatividad/selectAllNormatividadByEntidades.php") ?>&idEntidades=<?php echo $_GET['idEntidades'] ?>&order=numero&dir=asc'>
							<span class='fas fa-sort-amount-up'></span></a>
						<?php } ?>
						<?php if($order=="numero" && $dir=="desc") { ?>
							<span class='fas fa-sort-down'></span>
						<?php } else { ?>
							<a data-toggle='tooltip' class='tooltipLink' data-original-title='Sort Descending' href='index.php?pid=<?php echo base64_encode("ui/normatividad/selectAllNormatividadByEntidades.php") ?>&idEntidades=<?php echo $_GET['idEntidades'] ?>&order=numero&dir=desc'>
						...
						<?php if($order=="anio" && $dir=="asc") { ?>
							<span class='fas fa-sort-up'></span>
						<?php } else { ?>
							<a data-toggle='tooltip' class='tooltipLink' data-original-title='Sort Ascending' href='index.php?pid=<?php echo base64_encode("ui/normatividad/selectAllNormatividadByEntidades.php") ?>&idEntidades=<?php echo $_GET['idEntidades'] ?>&order=anio&dir=asc'>
							<span class='fas fa-sort-amount-up'></span></a>
						<?php } ?>
						<?php if($order=="anio" && $dir=="desc") { ?>
							<span class='fas fa-sort-down'></span>
						<?php } else { ?>
							<a data-toggle='tooltip' class='tooltipLink' data-original-title='Sort Descending' href='index.php?pid=<?php echo base64_encode("ui/normatividad/selectAllNormatividadByEntidades.php") ?>&idEntidades=<?php echo $_GET['idEntidades'] ?>&order=anio&dir=desc'>
							<span class='fas fa-sort-amount-down'></span></a>
						<?php } ?>
						</th>
						<th nowrap>Objetivo 
						<?php if($order=="objetivo" && $dir=="asc") { ?>
							<span class='fas fa-sort-up'></span>
						<?php } else { ?>
							<a data-toggle='tooltip' class='tooltipLink' data-original-title='Sort Ascending' href='index.php?pid=<?php echo base64_encode("ui/normatividad/selectAllNormatividadByEntidades.php") ?>&idEntidades=<?php echo $_GET['idEntidades'] ?>&order=objetivo&dir=asc'>
							<span class='fas fa-sort-amount-up'></span></a>
						<?php } ?>
						<?php if($order=="objetivo" && $dir=="desc") { ?>
							<span class='fas fa-sort-down'></span>
						<?php } else { ?>
							<a data-toggle='tooltip' class='tooltipLink' data-original-title='Sort Descending' href='index.php?pid=<?php echo base64_encode("ui/normatividad/selectAllNormatividadByEntidades.php") ?>&idEntidades=<?php echo $_GET['idEntidades'] ?>&order=objetivo&dir=desc'>
							<span class='fas fa-sort-amount-down'></span></a>
						<?php } ?>
						</th>
					...
					<?php
					$normatividad = new Normatividad("", "", "", "", "", $_GET['idEntidades'], "", "");
					if($order!="" && $dir!="") {
						$normatividads = $normatividad -> selectAllByEntidadesOrder($order, $dir);
					} else {
						$normatividads = $normatividad -> selectAllByEntidades();
					}
					$counter = 1;
