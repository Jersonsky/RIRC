...
if(isset($_POST['update'])){
	...
	if($type!="image/png"){
		...
		if($_SESSION['entity'] == 'Administrator'){
			$logAdministrator = new LogAdministrator("","Cambiar foto en administrador", "Foto: " . $serverPath, date("Y-m-d"), date("H:i:s"), $user_ip, PHP_OS, $browser, $_SESSION['id']);
		...
		<div class="col-md-8">
			<div class="card">
				<div class="card-header">
					<h4 class="card-title">Cambiar <?php echo $attribute ?> del Administrador</h4>
				</div>
				<div class="card-body">
					<?php if($processed){ ?>
					<div class="alert alert-success" >Foto Editada exitosamente.
