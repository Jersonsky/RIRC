...
$documentoJuridico = new DocumentoJuridico($_GET['idDocumentoJuridico']); 
$documentoJuridico -> select();
?>
<div class="container-fluid">
	<div class="card">
		<div class="card-header">
			<h4 class="card-title">Get All Normatividad of Documento Juridico: <em><?php echo $documentoJuridico -> getNombre() ?></em></h4>
		</div>
		<div class="card-body">
			...
			<table class="table table-striped table-hover">
				<thead>
					<tr><th></th>
						...
						<?php } else { ?>
							<a data-toggle='tooltip' class='tooltipLink' data-original-title='Sort Ascending' href='index.php?pid=<?php echo base64_encode("ui/normatividad/selectAllNormatividadByDocumentoJuridico.php") ?>&idDocumentoJuridico=<?php echo $_GET['idDocumentoJuridico'] ?>&order=numero&dir=asc'>
							<span class='fas fa-sort-amount-up'></span></a>
						<?php } ?>
						<?php if($order=="numero" && $dir=="desc") { ?>
							<span class='fas fa-sort-down'></span>
						<?php } else { ?>
							<a data-toggle='tooltip' class='tooltipLink' data-original-title='Sort Descending' href='index.php?pid=<?php echo base64_encode("ui/normatividad/selectAllNormatividadByDocumentoJuridico.php") ?>&idDocumentoJuridico=<?php echo $_GET['idDocumentoJuridico'] ?>&order=numero&dir=desc'>
						...
						<?php if($order=="anio" && $dir=="asc") { ?>
							<span class='fas fa-sort-up'></span>
						<?php } else { ?>
							<a data-toggle='tooltip' class='tooltipLink' data-original-title='Sort Ascending' href='index.php?pid=<?php echo base64_encode("ui/normatividad/selectAllNormatividadByDocumentoJuridico.php") ?>&idDocumentoJuridico=<?php echo $_GET['idDocumentoJuridico'] ?>&order=anio&dir=asc'>
							<span class='fas fa-sort-amount-up'></span></a>
						<?php } ?>
						<?php if($order=="anio" && $dir=="desc") { ?>
							<span class='fas fa-sort-down'></span>
						<?php } else { ?>
							<a data-toggle='tooltip' class='tooltipLink' data-original-title='Sort Descending' href='index.php?pid=<?php echo base64_encode("ui/normatividad/selectAllNormatividadByDocumentoJuridico.php") ?>&idDocumentoJuridico=<?php echo $_GET['idDocumentoJuridico'] ?>&order=anio&dir=desc'>
							<span class='fas fa-sort-amount-down'></span></a>
						<?php } ?>
						</th>
						<th nowrap>Objetivo 
						<?php if($order=="objetivo" && $dir=="asc") { ?>
							<span class='fas fa-sort-up'></span>
						<?php } else { ?>
							<a data-toggle='tooltip' class='tooltipLink' data-original-title='Sort Ascending' href='index.php?pid=<?php echo base64_encode("ui/normatividad/selectAllNormatividadByDocumentoJuridico.php") ?>&idDocumentoJuridico=<?php echo $_GET['idDocumentoJuridico'] ?>&order=objetivo&dir=asc'>
							<span class='fas fa-sort-amount-up'></span></a>
						<?php } ?>
						<?php if($order=="objetivo" && $dir=="desc") { ?>
							<span class='fas fa-sort-down'></span>
						<?php } else { ?>
							<a data-toggle='tooltip' class='tooltipLink' data-original-title='Sort Descending' href='index.php?pid=<?php echo base64_encode("ui/normatividad/selectAllNormatividadByDocumentoJuridico.php") ?>&idDocumentoJuridico=<?php echo $_GET['idDocumentoJuridico'] ?>&order=objetivo&dir=desc'>
							<span class='fas fa-sort-amount-down'></span></a>
						<?php } ?>
						</th>
					...
					<?php
					$normatividad = new Normatividad("", "", "", "", $_GET['idDocumentoJuridico'], "", "", "");
					if($order!="" && $dir!="") {
						$normatividads = $normatividad -> selectAllByDocumentoJuridicoOrder($order, $dir);
					} else {
						$normatividads = $normatividad -> selectAllByDocumentoJuridico();
					}
					$counter = 1;
