...
if(isset($_POST['update'])){
	...
	if($type!="image/png"){
		...
		if($_SESSION['entity'] == 'Administrator'){
			$logAdministrator = new LogAdministrator("","Editar Foto de Perfil  de Administrator", "Foto: " . $serverPath, date("Y-m-d"), date("H:i:s"), $user_ip, PHP_OS, $browser, $_SESSION['id']);
	...
	<div class="row">
		...
		<div class="col-md-8">
			<div class="card">
				...
				<div class="card-body">
					<?php if($processed){ ?>
					<div class="alert alert-success" >Foto Cambiada exitosamente.
