...
$subcapitulo = new Subcapitulo($idSubcapitulo);
$subcapitulo -> select();
?>
...
<div class="modal-header">
	<h4 class="modal-title">Subcapitulo</h4>
...
<div class="modal-body">
	<table class="table table-striped table-hover">
		<tr>
			<th>Nombre</th>
			<td><?php echo $subcapitulo -> getNombre() ?></td>
		</tr>
		<tr>
			<th>Capitulo</th>
			<td><?php echo $subcapitulo -> getCapitulo() -> getNombre() ?></td>
		</tr>
	</table>
</div>
