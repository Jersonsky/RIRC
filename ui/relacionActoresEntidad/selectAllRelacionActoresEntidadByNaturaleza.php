...
$naturaleza = new Naturaleza($_GET['idNaturaleza']); 
$naturaleza -> select();
?>
<div class="container-fluid">
	<div class="card">
		<div class="card-header">
			<h4 class="card-title">Get All Relacion Actores Entidad of Naturaleza: <em><?php echo $naturaleza -> getNombre() ?></em></h4>
		</div>
		<div class="card-body">
			...
			<table class="table table-striped table-hover">
				<thead>
					<tr><th></th>
						...
						<?php } else { ?>
							<a data-toggle='tooltip' class='tooltipLink' data-original-title='Sort Ascending' href='index.php?pid=<?php echo base64_encode("ui/relacionActoresEntidad/selectAllRelacionActoresEntidadByNaturaleza.php") ?>&idNaturaleza=<?php echo $_GET['idNaturaleza'] ?>&order=siglas&dir=asc'>
							<span class='fas fa-sort-amount-up'></span></a>
						<?php } ?>
						<?php if($order=="siglas" && $dir=="desc") { ?>
							<span class='fas fa-sort-down'></span>
						<?php } else { ?>
							<a data-toggle='tooltip' class='tooltipLink' data-original-title='Sort Descending' href='index.php?pid=<?php echo base64_encode("ui/relacionActoresEntidad/selectAllRelacionActoresEntidadByNaturaleza.php") ?>&idNaturaleza=<?php echo $_GET['idNaturaleza'] ?>&order=siglas&dir=desc'>
						...
						<?php if($order=="telefono" && $dir=="asc") { ?>
							<span class='fas fa-sort-up'></span>
						<?php } else { ?>
							<a data-toggle='tooltip' class='tooltipLink' data-original-title='Sort Ascending' href='index.php?pid=<?php echo base64_encode("ui/relacionActoresEntidad/selectAllRelacionActoresEntidadByNaturaleza.php") ?>&idNaturaleza=<?php echo $_GET['idNaturaleza'] ?>&order=telefono&dir=asc'>
							<span class='fas fa-sort-amount-up'></span></a>
						<?php } ?>
						<?php if($order=="telefono" && $dir=="desc") { ?>
							<span class='fas fa-sort-down'></span>
						<?php } else { ?>
							<a data-toggle='tooltip' class='tooltipLink' data-original-title='Sort Descending' href='index.php?pid=<?php echo base64_encode("ui/relacionActoresEntidad/selectAllRelacionActoresEntidadByNaturaleza.php") ?>&idNaturaleza=<?php echo $_GET['idNaturaleza'] ?>&order=telefono&dir=desc'>
							<span class='fas fa-sort-amount-down'></span></a>
						<?php } ?>
						</th>
						...
						<?php if($order=="pagina_Web" && $dir=="asc") { ?>
							<span class='fas fa-sort-up'></span>
						<?php } else { ?>
							<a data-toggle='tooltip' class='tooltipLink' data-original-title='Sort Ascending' href='index.php?pid=<?php echo base64_encode("ui/relacionActoresEntidad/selectAllRelacionActoresEntidadByNaturaleza.php") ?>&idNaturaleza=<?php echo $_GET['idNaturaleza'] ?>&order=pagina_Web&dir=asc'>
							<span class='fas fa-sort-amount-up'></span></a>
						<?php } ?>
						<?php if($order=="pagina_Web" && $dir=="desc") { ?>
							<span class='fas fa-sort-down'></span>
						<?php } else { ?>
							<a data-toggle='tooltip' class='tooltipLink' data-original-title='Sort Descending' href='index.php?pid=<?php echo base64_encode("ui/relacionActoresEntidad/selectAllRelacionActoresEntidadByNaturaleza.php") ?>&idNaturaleza=<?php echo $_GET['idNaturaleza'] ?>&order=pagina_Web&dir=desc'>
							<span class='fas fa-sort-amount-down'></span></a>
						<?php } ?>
						</th>
						<th nowrap>Correo 
						<?php if($order=="correo" && $dir=="asc") { ?>
							<span class='fas fa-sort-up'></span>
						<?php } else { ?>
							<a data-toggle='tooltip' class='tooltipLink' data-original-title='Sort Ascending' href='index.php?pid=<?php echo base64_encode("ui/relacionActoresEntidad/selectAllRelacionActoresEntidadByNaturaleza.php") ?>&idNaturaleza=<?php echo $_GET['idNaturaleza'] ?>&order=correo&dir=asc'>
							<span class='fas fa-sort-amount-up'></span></a>
						<?php } ?>
						<?php if($order=="correo" && $dir=="desc") { ?>
							<span class='fas fa-sort-down'></span>
						<?php } else { ?>
							<a data-toggle='tooltip' class='tooltipLink' data-original-title='Sort Descending' href='index.php?pid=<?php echo base64_encode("ui/relacionActoresEntidad/selectAllRelacionActoresEntidadByNaturaleza.php") ?>&idNaturaleza=<?php echo $_GET['idNaturaleza'] ?>&order=correo&dir=desc'>
							<span class='fas fa-sort-amount-down'></span></a>
						<?php } ?>
						</th>
						...
						<?php if($order=="descripcion" && $dir=="asc") { ?>
							<span class='fas fa-sort-up'></span>
						<?php } else { ?>
							<a data-toggle='tooltip' class='tooltipLink' data-original-title='Sort Ascending' href='index.php?pid=<?php echo base64_encode("ui/relacionActoresEntidad/selectAllRelacionActoresEntidadByNaturaleza.php") ?>&idNaturaleza=<?php echo $_GET['idNaturaleza'] ?>&order=descripcion&dir=asc'>
							<span class='fas fa-sort-amount-up'></span></a>
						<?php } ?>
						<?php if($order=="descripcion" && $dir=="desc") { ?>
							<span class='fas fa-sort-down'></span>
						<?php } else { ?>
							<a data-toggle='tooltip' class='tooltipLink' data-original-title='Sort Descending' href='index.php?pid=<?php echo base64_encode("ui/relacionActoresEntidad/selectAllRelacionActoresEntidadByNaturaleza.php") ?>&idNaturaleza=<?php echo $_GET['idNaturaleza'] ?>&order=descripcion&dir=desc'>
							<span class='fas fa-sort-amount-down'></span></a>
						<?php } ?>
						</th>
						<th>Entidades</th>
					...
					<?php
					$relacionActoresEntidad = new RelacionActoresEntidad("", "", "", "", "", "", "", "", $_GET['idNaturaleza'], "", "");
					if($order!="" && $dir!="") {
						$relacionActoresEntidads = $relacionActoresEntidad -> selectAllByNaturalezaOrder($order, $dir);
					} else {
						$relacionActoresEntidads = $relacionActoresEntidad -> selectAllByNaturaleza();
					}
					$counter = 1;
