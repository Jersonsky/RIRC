...
<div class="container-fluid">
	<div class="card">
		<div class="card-header">
			<h4 class="card-title">Get All Relacion Actores Entidad of Sector: <em><?php echo $sector -> getNombre() ?></em></h4>
		</div>
		<div class="card-body">
			...
			<table class="table table-striped table-hover">
				<thead>
					<tr><th></th>
						...
						<?php } else { ?>
							<a data-toggle='tooltip' class='tooltipLink' data-original-title='Sort Ascending' href='index.php?pid=<?php echo base64_encode("ui/relacionActoresEntidad/selectAllRelacionActoresEntidadBySector.php") ?>&idSector=<?php echo $_GET['idSector'] ?>&order=siglas&dir=asc'>
							<span class='fas fa-sort-amount-up'></span></a>
						<?php } ?>
						<?php if($order=="siglas" && $dir=="desc") { ?>
							<span class='fas fa-sort-down'></span>
						<?php } else { ?>
							<a data-toggle='tooltip' class='tooltipLink' data-original-title='Sort Descending' href='index.php?pid=<?php echo base64_encode("ui/relacionActoresEntidad/selectAllRelacionActoresEntidadBySector.php") ?>&idSector=<?php echo $_GET['idSector'] ?>&order=siglas&dir=desc'>
						...
						<?php if($order=="telefono" && $dir=="asc") { ?>
							<span class='fas fa-sort-up'></span>
						<?php } else { ?>
							<a data-toggle='tooltip' class='tooltipLink' data-original-title='Sort Ascending' href='index.php?pid=<?php echo base64_encode("ui/relacionActoresEntidad/selectAllRelacionActoresEntidadBySector.php") ?>&idSector=<?php echo $_GET['idSector'] ?>&order=telefono&dir=asc'>
							<span class='fas fa-sort-amount-up'></span></a>
						<?php } ?>
						<?php if($order=="telefono" && $dir=="desc") { ?>
							<span class='fas fa-sort-down'></span>
						<?php } else { ?>
							<a data-toggle='tooltip' class='tooltipLink' data-original-title='Sort Descending' href='index.php?pid=<?php echo base64_encode("ui/relacionActoresEntidad/selectAllRelacionActoresEntidadBySector.php") ?>&idSector=<?php echo $_GET['idSector'] ?>&order=telefono&dir=desc'>
							<span class='fas fa-sort-amount-down'></span></a>
						<?php } ?>
						</th>
						...
						<?php if($order=="pagina_Web" && $dir=="asc") { ?>
							<span class='fas fa-sort-up'></span>
						<?php } else { ?>
							<a data-toggle='tooltip' class='tooltipLink' data-original-title='Sort Ascending' href='index.php?pid=<?php echo base64_encode("ui/relacionActoresEntidad/selectAllRelacionActoresEntidadBySector.php") ?>&idSector=<?php echo $_GET['idSector'] ?>&order=pagina_Web&dir=asc'>
							<span class='fas fa-sort-amount-up'></span></a>
						<?php } ?>
						<?php if($order=="pagina_Web" && $dir=="desc") { ?>
							<span class='fas fa-sort-down'></span>
						<?php } else { ?>
							<a data-toggle='tooltip' class='tooltipLink' data-original-title='Sort Descending' href='index.php?pid=<?php echo base64_encode("ui/relacionActoresEntidad/selectAllRelacionActoresEntidadBySector.php") ?>&idSector=<?php echo $_GET['idSector'] ?>&order=pagina_Web&dir=desc'>
							<span class='fas fa-sort-amount-down'></span></a>
						<?php } ?>
						</th>
						<th nowrap>Correo 
						<?php if($order=="correo" && $dir=="asc") { ?>
							<span class='fas fa-sort-up'></span>
						<?php } else { ?>
							<a data-toggle='tooltip' class='tooltipLink' data-original-title='Sort Ascending' href='index.php?pid=<?php echo base64_encode("ui/relacionActoresEntidad/selectAllRelacionActoresEntidadBySector.php") ?>&idSector=<?php echo $_GET['idSector'] ?>&order=correo&dir=asc'>
							<span class='fas fa-sort-amount-up'></span></a>
						<?php } ?>
						<?php if($order=="correo" && $dir=="desc") { ?>
							<span class='fas fa-sort-down'></span>
						<?php } else { ?>
							<a data-toggle='tooltip' class='tooltipLink' data-original-title='Sort Descending' href='index.php?pid=<?php echo base64_encode("ui/relacionActoresEntidad/selectAllRelacionActoresEntidadBySector.php") ?>&idSector=<?php echo $_GET['idSector'] ?>&order=correo&dir=desc'>
							<span class='fas fa-sort-amount-down'></span></a>
						<?php } ?>
						</th>
						...
						<?php if($order=="descripcion" && $dir=="asc") { ?>
							<span class='fas fa-sort-up'></span>
						<?php } else { ?>
							<a data-toggle='tooltip' class='tooltipLink' data-original-title='Sort Ascending' href='index.php?pid=<?php echo base64_encode("ui/relacionActoresEntidad/selectAllRelacionActoresEntidadBySector.php") ?>&idSector=<?php echo $_GET['idSector'] ?>&order=descripcion&dir=asc'>
							<span class='fas fa-sort-amount-up'></span></a>
						<?php } ?>
						<?php if($order=="descripcion" && $dir=="desc") { ?>
							<span class='fas fa-sort-down'></span>
						<?php } else { ?>
							<a data-toggle='tooltip' class='tooltipLink' data-original-title='Sort Descending' href='index.php?pid=<?php echo base64_encode("ui/relacionActoresEntidad/selectAllRelacionActoresEntidadBySector.php") ?>&idSector=<?php echo $_GET['idSector'] ?>&order=descripcion&dir=desc'>
							<span class='fas fa-sort-amount-down'></span></a>
						<?php } ?>
						</th>
						<th>Entidades</th>
					...
					<?php
					$relacionActoresEntidad = new RelacionActoresEntidad("", "", "", "", "", "", "", "", "", "", $_GET['idSector']);
					if($order!="" && $dir!="") {
						$relacionActoresEntidads = $relacionActoresEntidad -> selectAllBySectorOrder($order, $dir);
					} else {
						$relacionActoresEntidads = $relacionActoresEntidad -> selectAllBySector();
					}
					$counter = 1;
