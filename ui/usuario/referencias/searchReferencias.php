...
<div class="container-fluid">
			...
			<div class="col text-left pl-0 pt-4">
				<div class="text-uppercase text-success">
					Gesti&oacute;n <br>Documental
				</div>
			</div>
		</div>
		<hr>
				<div class="row">
					...
					<br>
						<input type="text" class="form-control border border-success" id="search" placeholder="Buscador de Referencias" autocomplete="off" />
					</div>
				</div>
			</div>
...
$(document).ready(function(){
	$("#search").keyup(function(){
		if($("#search").val().length > 2){
			...
			var path = "indexAjax.php?pid=<?php echo base64_encode("ui/usuario/referencias/searchReferenciasAjax.php"); ?>&search="+search;
