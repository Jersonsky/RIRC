...
$normatividad = new Normatividad($_GET['idNormatividad']); 
$normatividad -> select();
$error = 0;
...
<div class="container-fluid">
	<div class="card">
		<div class="card-header">
			<h4 class="card-title">Get All Tema Normatividad of Normatividad: <em><?php echo $normatividad -> getNumero() . " " . $normatividad -> getAnio() ?></em></h4>
		</div>
		<div class="card-body">
			...
			<table class="table table-striped table-hover">
				<thead>
					<tr><th></th>
						...
						<?php } else { ?>
							<a data-toggle='tooltip' class='tooltipLink' data-original-title='Sort Ascending' href='index.php?pid=<?php echo base64_encode("ui/temaNormatividad/selectAllTemaNormatividadByNormatividad.php") ?>&idNormatividad=<?php echo $_GET['idNormatividad'] ?>&order=desripcion&dir=asc'>
							<span class='fas fa-sort-amount-up'></span></a>
						<?php } ?>
						<?php if($order=="desripcion" && $dir=="desc") { ?>
							<span class='fas fa-sort-down'></span>
						<?php } else { ?>
							<a data-toggle='tooltip' class='tooltipLink' data-original-title='Sort Descending' href='index.php?pid=<?php echo base64_encode("ui/temaNormatividad/selectAllTemaNormatividadByNormatividad.php") ?>&idNormatividad=<?php echo $_GET['idNormatividad'] ?>&order=desripcion&dir=desc'>
					...
					<?php
					$temaNormatividad = new TemaNormatividad("", "", $_GET['idNormatividad'], "");
					if($order!="" && $dir!="") {
						$temaNormatividads = $temaNormatividad -> selectAllByNormatividadOrder($order, $dir);
					} else {
						$temaNormatividads = $temaNormatividad -> selectAllByNormatividad();
					}
					$counter = 1;
