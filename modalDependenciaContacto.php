...
$dependenciaContacto = new DependenciaContacto($idDependenciaContacto);
...
<div class="modal-header">
	<h4 class="modal-title">Dependencia Contacto</h4>
...
<div class="modal-body">
	<table class="table table-striped table-hover">
		<tr>
			<th>Nombre</th>
			<td><?php echo $dependenciaContacto -> getNombre() ?></td>
		</tr>
	</table>
</div>
