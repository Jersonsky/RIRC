			...
			<table class="table table-striped table-hover">
				<thead>
					...
					foreach ($administrators as $currentAdministrator) {
						...
						echo "<td>" . ($currentAdministrator -> getState()==1?"Habilitado":"Desabilitado") . "</td>";
						...
						if($_SESSION['entity'] == 'Administrator') {
							...
							echo "<a href='index.php?pid=" . base64_encode("ui/administrator/updatePictureAdministrator.php") . "&idAdministrator=" . $currentAdministrator -> getIdAdministrator() . "&attribute=picture'><span class='fas fa-camera' data-toggle='tooltip' data-placement='left' class='tooltipLink' data-original-title='Cambiar Foto'></span></a> ";
						}
						echo "</td>";
						echo "</tr>";
						$counter++;
