...
<div class="container-fluid">
	<div class="card">
		<div class="card-header">
			<h4 class="card-title">Listar Sectores</h4>
		</div>
		<div class="card-body">
			...
			<table class="table table-striped table-hover">
				<thead>
					<tr><th></th>
						...
						<?php } else { ?>
							<a href='index.php?pid=<?php echo base64_encode("ui/sector/selectAllSector.php") ?>&order=nombre&dir=asc'>
						...
						<?php } else { ?>
							<a href='index.php?pid=<?php echo base64_encode("ui/sector/selectAllSector.php") ?>&order=nombre&dir=desc'>
					...
					$sector = new Sector();
					if($order != "" && $dir != "") {
						$sectors = $sector -> selectAllOrder($order, $dir);
					} else {
					...
					foreach ($sectors as $currentSector) {
						...
						echo "<td>" . $currentSector -> getNombre() . "</td>";
